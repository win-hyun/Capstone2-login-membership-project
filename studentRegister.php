<?php
    ...
    $nameCheckqueery =  "SELECT name FROM student_users WHERE name = '" . $username . "';";
    ...
    $insertuserquery = "INSERT INTO student_users (name, student_id, password, email) values('" . $username . "', '" . $userid . "', '". $password . "', '" . $email . "');";
